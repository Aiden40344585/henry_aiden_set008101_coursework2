...
// Encryption and Decryption Website USERLIST JavaScript file
...
function rec_mess()
{
    var x = document.getElementById("sent_message_table");
    x.style.display = "none";
    var x = document.getElementById("received_message_table");
        if (x.style.display === "none") 
            {
